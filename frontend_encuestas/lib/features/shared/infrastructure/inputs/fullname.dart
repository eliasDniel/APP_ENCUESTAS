...
enum FullNameError { empty, tooLong }
...
class FullName extends FormzInput<String, FullNameError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == FullNameError.tooLong) return 'No puede tener más de 100 caracteres';
    return null;
  }
  ...
  FullNameError? validator(String value) {
    ...
    if (value.length > maxLength) return FullNameError.tooLong;
    return null;
  }
}
